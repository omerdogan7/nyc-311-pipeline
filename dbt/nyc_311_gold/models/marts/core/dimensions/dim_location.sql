...
final as (
    select
        ...
        case
            ...
            when zip_code like '111%' or zip_code like '113%'
                 or zip_code like '114%' or zip_code like '115%' or zip_code like '116%'
                then 'Queens'
        ...
        -- Flags
        coalesce(zip_code != 'NO_ZIP', false) as has_zip,
        coalesce(borough != 'UNSPECIFIED', false) as is_specified,
